...
export function createMainWindow() {
  ...
  // StoatModded: le menu natif est désactivé ci-dessus, ce qui désactive
  // aussi le raccourci DevTools par défaut sur Windows/Linux (confirmé :
  // fonctionne sur macOS car le menu système reste actif différemment).
  // On le recâble manuellement pour ne pas dépendre du menu.
